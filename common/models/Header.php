...
class Header extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['organization_name', 'organization_address', 'contact', 'logo', 'created_by', 'created_at', 'organization_id'], 'required'],
            [['contact', 'logo', 'created_by', 'created_at', 'organization_id'], 'integer'],
