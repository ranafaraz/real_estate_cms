...
class receipt extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['receiver_payer_id', 'transaction_id', 'type', 'narration', 'debit_account', 'debit_amount', 'credit_account', 'credit_amount', 'date', 'created_by', 'updated_by', 'updated_at'], 'required'],
