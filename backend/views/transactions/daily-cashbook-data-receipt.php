...
$header = Header::find()->where(['organization_id' => \Yii::$app->user->identity->organization_id])->One();
			$returndata.='
						...
						<div class="row" id="show-record1">
							...
							<div class="row">
							<div class="col-md-12">
								<div class="row text-center" style="margin-top:5px !important;margin-bottom:5px !important;"><div class="col-md-12 bg-success"><h4 class="text-info font-wight-bold">Showing Report Against Date: <b class="text-danger" id="si_date"></b> to <b class="text-danger" id="ei_date"></b></h4>
			...
			$returndata.='<tr>
							...
							<th class="text-center text-dark bg-success">Receipts</th>
		...
		foreach ($head_query as $value) {
			...
			{
				$a=$a+1;
				$head_model_debit = AccountHead::find()->where(["id" => $val1->credit_account])->One();
