...
class ReceiptController extends Controller
{
                    ...
                    if ($model->save()) {
                        $transaction->commit();
                         return [
                            ...
                            'title'=> "Create new Receipt",
                            'content'=>'<span class="text-success">Create Receipt success</span>',
                            'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                        ...
                        $transaction->rollback();
                         return [
                            'forceReload'=>'#crud-datatable-pjax',
                            'title'=> "Create new Receipt",
                            'content'=>'<span class="text-success">Create Receipt Failed! Please try again.</span>',
                            'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                                    Html::a('Create More',['create'],['class'=>'btn btn-primary','role'=>'modal-remote'])
    ...
    /**
     * Delete an existing Receipt model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Receipt model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
