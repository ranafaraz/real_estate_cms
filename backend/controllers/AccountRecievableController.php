...
/**
 * AccountRecievableController implements the CRUD actions for AccountRecievable model.
 */
class AccountRecievableController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all AccountRecievable models.
     * @return mixed
     */
    ...
    /**
     * Displays a single AccountRecievable model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new AccountRecievable model.
    ...
    /**
     * Updates an existing AccountRecievable model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing AccountRecievable model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing AccountRecievable model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the AccountRecievable model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AccountRecievable the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AccountRecievable::findOne($id)) !== null) {
            return $model;
        } else {
