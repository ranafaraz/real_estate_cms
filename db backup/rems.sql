...
--
-- Error reading structure for table rems.auth_assignment: #1932 - Table 'rems.auth_assignment' doesn't exist in engine
-- Error reading data for table rems.auth_assignment: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `rems`.`auth_assignment`' at line 1
...
--
-- Error reading structure for table rems.auth_item_child: #1932 - Table 'rems.auth_item_child' doesn't exist in engine
-- Error reading data for table rems.auth_item_child: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `rems`.`auth_item_child`' at line 1
...
CREATE TABLE `installment` (
  ...
  `remaning_amount` varchar(250) NOT NULL,
...
INSERT INTO `installment` (`installment_id`, `installment_type`, `remaning_amount`, `total_amount`, `no_of_installments`, `customer_id`, `property_id`, `organization_id`, `plot_no`) VALUES
...
INSERT INTO `installment_status` (`id`, `installment_id`, `installment_no`, `installment_amount`, `status`, `date`, `paid_date`, `created_by`) VALUES
(38, 62, 1, 80000, 0, '2019-09-10', '2019-10-10', '1'),
(39, 62, 2, 40000, 0, '2019-09-10', '2019-10-10', '1'),
(40, 62, 3, 40000, 0, '2019-09-10', '2019-10-10', '1'),
(41, 62, 4, 40000, 0, '2019-09-10', '2019-10-10', '1'),
(42, 63, 1, 10, 0, '2019-09-11', '2020-09-11', '1'),
(43, 63, 2, 1, 0, '2019-09-11', '2020-09-11', '1'),
(44, 63, 3, 1, 1, '2019-09-11', '2020-09-11', '1'),
(45, 63, 4, 1, 1, '2019-09-11', '2020-09-11', '1'),
(46, 63, 5, 1, 1, '2019-09-11', '2020-09-11', '1'),
(47, 63, 6, 1, 1, '2019-09-11', '2020-09-11', '1'),
(48, 63, 7, 1, 1, '2019-09-11', '2020-09-11', '1'),
(49, 63, 8, 1, 1, '2019-09-11', '2020-09-11', '1'),
(50, 63, 9, 1, 1, '2019-09-11', '2020-09-11', '1'),
(51, 63, 10, 1, 1, '2019-09-11', '2020-09-11', '1'),
(52, 63, 11, 1, 1, '2019-09-11', '2020-09-11', '1'),
(53, 64, 1, 20000, 0, '2019-09-11', '2019-10-11', '1'),
(54, 64, 2, 10000, 0, '2019-09-11', '2019-10-11', '1'),
(55, 64, 3, 10000, 1, '2019-09-11', '2019-10-11', '1'),
(56, 64, 4, 10000, 1, '2019-09-11', '2019-10-11', '1'),
(57, 64, 5, 10000, 1, '2019-09-11', '2019-10-11', '1'),
(58, 64, 6, 10000, 1, '2019-09-11', '2019-10-11', '1'),
(59, 64, 7, 10000, 1, '2019-09-11', '2019-10-11', '1'),
(60, 64, 8, 10000, 1, '2019-09-11', '2019-10-11', '1'),
(61, 64, 9, 10000, 1, '2019-09-11', '2019-10-11', '1'),
(62, 64, 10, 10000, 1, '2019-09-11', '2019-10-11', '1'),
(63, 64, 11, 10000, 1, '2019-09-11', '2019-10-11', '1');
...
(175, 20, 1, '1123', '1', 'Residential', 1, 123, 'Sold', 'Usama', '2019-09-11', '', '0000-00-00', 1),
(176, 20, 2, '132333', '13433331', 'Residential', 234234123, 112333, 'Sold', 'Usama', '2019-09-11', '', '0000-00-00', 1),
...
(190, 21, 1, '1', '1', 'Residential', 1, 1, 'Unsold', 'Usama', '2019-09-11', '', '0000-00-00', 1),
(191, 21, 2, '1', '1', 'Residential', 1, 1, 'Unsold', 'Usama', '2019-09-11', '', '0000-00-00', 1),
(192, 21, 3, '1', '1', 'Residential', 1, 1, 'Unsold', 'Usama', '2019-09-11', '', '0000-00-00', 1),
...
(20, 'garden A', '12', 120000, 'abc', 'abc', 'abc', 'abc', 'Usama', '2019-09-11', 1, 15),
...
INSERT INTO `provide_services` (`provide_services_id`, `customer_id`, `services_type_id`, `services_id`, `organization_id`) VALUES
(1, 1, 1, 2, 1),
(2, 2, 1, 2, 2),
(3, 2, 1, 2, 1),
(4, 86, 4, 3, 1),
...
INSERT INTO `user` (`id`, `username`, `organization_id`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `created_at`, `updated_at`, `verification_token`) VALUES
(1, 'Usama', 1, 'E3o-4bvdBwY6RnwN7VZK3NEFhlxVeDh_', '$2y$13$4v6XFm7Ns0WGmRcs0GresOXGiB4JYHkHUW6Uy8GFfufp/Vp2y8tF.', NULL, 'Usama786.sa@gmail.com', 10, 1567424338, 1567424338, 'afBrvzkCdFjDVOnD3kOSO2ChTjA5j2a4_1567424338');
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`organization_id`) REFERENCES `organization` (`id`);
