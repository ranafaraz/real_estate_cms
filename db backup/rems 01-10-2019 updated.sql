...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2019 at 09:54 AM
...
--
-- RELATIONSHIPS FOR TABLE `account_head`:
--   `nature_id`
--       `account_nature` -> `id`
--
...
--
-- RELATIONSHIPS FOR TABLE `account_nature`:
--   `organization_id`
--       `organization` -> `id`
--
...
--
-- RELATIONSHIPS FOR TABLE `account_payable`:
--   `account_payable`
--       `account_head` -> `id`
--   `recipient_id`
--       `payer_receiver_info` -> `id`
--
...
--
-- RELATIONSHIPS FOR TABLE `account_recievable`:
--   `payer_id`
--       `payer_receiver_info` -> `id`
--   `payer_receiver_id`
--       `account_head` -> `id`
...
--
-- RELATIONSHIPS FOR TABLE `buy_plot`:
--   `organization_id`
--       `organization` -> `id`
--   `customer_id`
...
(13, 21, 'jk', '1', '12', 1200000000, 'jjhgjhgljkgkjh', 'ryk', 'ryk', 'punjab', '0000-00-00', '2019-09-28', 74, NULL, NULL, 'Self Owned', 1),
(14, 22, 'jk', '1', '12', 1200000000, 'jjhgjhgljkgkjh', 'ryk', 'ryk', 'punjab', '0000-00-00', '2019-09-28', 74, NULL, NULL, 'Self Owned', 1),
(15, 21, 'qwe', '1', '120', 12000000, 'mm', 'RYK', 'RYK', 'punjab', '0000-00-00', '2019-09-29', 74, NULL, NULL, 'Self Owned', 1),
(16, 21, 'm', '3', '12', 12000000, 'jkhjhjk\r\n', 'ryk', 'ryk', 'punjab', '0000-00-00', '2019-09-29', 74, NULL, NULL, 'Customer Owned', 1),
(17, 23, 'uiio', '123', '7676', 23123123123, 'jgjh', 'ryk', 'ryk', 'punjab', '0000-00-00', '2019-09-29', 74, NULL, NULL, 'Self Owned', 1),
(18, 23, 'Gulshan Iqbal', '10', '23*23', 12000000, ',.m,,m,nm,n', 'RYK', 'RYK', 'punjab', '0000-00-00', '2019-09-29', 74, NULL, NULL, 'Self Owned', 1),
(19, 23, 'Gulshan Iqba', '2', '23*23', 23123123123, 'sdjnfsjkhjk', 'RYK', 'RYK', 'punjab', '0000-00-00', '2019-09-29', 74, NULL, NULL, 'Self Owned', 1);
...
--
-- RELATIONSHIPS FOR TABLE `customer_type`:
--
...
--
-- RELATIONSHIPS FOR TABLE `employee_types`:
--   `organization_id`
--       `organization` -> `id`
--
...
--
-- RELATIONSHIPS FOR TABLE `emp_salary`:
--   `emp_id`
--       `employee` -> `emp_id`
--   `organization_id`
--       `organization` -> `id`
...
--
-- RELATIONSHIPS FOR TABLE `installment_status`:
--   `installment_id`
...
--
-- RELATIONSHIPS FOR TABLE `payer_receiver_info`:
--   `head_id`
--       `account_head` -> `id`
--
...
--
-- RELATIONSHIPS FOR TABLE `plot_owner_info`:
--   `customer_id`
--       `customer` -> `customer_id`
--   `plot_no`
--       `plot` -> `plot_no`
...
--
-- RELATIONSHIPS FOR TABLE `property`:
--   `organization_id`
--       `organization` -> `id`
--
...
--
-- RELATIONSHIPS FOR TABLE `provide_services`:
--   `customer_id`
--       `customer` -> `customer_id`
--   `services_id`
--       `services_details` -> `services_id`
--   `services_type_id`
--       `services_type` -> `services_type_id`
--   `organization_id`
--       `organization` -> `id`
--
...
--
-- RELATIONSHIPS FOR TABLE `services_details`:
--   `services_type_id`
--       `services_type` -> `services_type_id`
--   `organization_id`
--       `organization` -> `id`
...
--
-- RELATIONSHIPS FOR TABLE `services_type`:
--   `organization_id`
--       `organization` -> `id`
--
...
INSERT INTO `transactions` (`id`, `transaction_id`, `type`, `narration`, `debit_account`, `debit_amount`, `credit_account`, `credit_amount`, `date`, `ref_no`, `created_by`, `updated_by`, `updated_at`, `transaction_type`, `organization_id`) VALUES
(2, 2, 'Cash Payment', 'loan', 16, 20000, 22, 20000, '2019-08-30 08:08:03', '', 'rehan', 'rehan', '2019-08-30 08:08:03', 'receipt', 0),
(31, 3, 'Cash Payment', 'kjknk', 20, 1200, 16, 1000, '2019-09-02 08:09:06', '', 'rehan', 'rehan', '2019-09-02 08:09:06', 'payment', 0),
(32, 4, 'Cash Payment', 'mnm', 20, 1200, 16, 1000, '2019-09-02 08:09:47', '', 'rehan', 'rehan', '2019-09-02 08:09:47', 'payment', 0),
(33, 5, 'Cash Payment', 'sdf', 20, 1000, 16, 100, '2019-09-02 08:09:18', '', 'rehan', 'rehan', '2019-09-02 08:09:18', 'payment', 0);
...
ALTER TABLE `account_recievable`
  ...
  ADD KEY `payer_receiver_id` (`payer_receiver_id`);
...
--
ALTER TABLE `buy_plot`
  MODIFY `buy_plot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
ALTER TABLE `account_recievable`
  ...
  ADD CONSTRAINT `account_recievable_ibfk_3` FOREIGN KEY (`payer_receiver_id`) REFERENCES `account_head` (`id`);
