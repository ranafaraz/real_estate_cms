...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2020 at 09:20 PM
...
INSERT INTO `account_head` (`id`, `organization_id`, `nature_id`, `account_name`, `account_no`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES
(15, 1, 15, 'Account Payable', '04-001', 'rehan', '2019-08-27 09:08:12', 'rehan', '2019-08-27 09:08:12'),
(16, 1, 14, 'Cash', '03-001', 'rehan', '2019-08-27 08:08:49', 'rehan', '2019-08-27 08:08:49'),
(18, 1, 13, 'Plot', '03-003', 'rehan', '2019-08-27 08:08:30', 'rehan', '2019-08-27 08:08:30'),
(19, 1, 15, 'Salaries', '06-001', 'rehan', '2019-08-27 08:08:08', 'rehan', '2019-08-27 08:08:08'),
(20, 1, 17, 'Utility Bills', '06-002', 'rehan', '2019-08-27 08:08:22', 'rehan', '2019-08-27 08:08:22'),
(21, 1, 13, 'Account Receivable', '03-004', 'rehan', '2019-08-30 08:08:39', 'rehan', '2019-08-30 08:08:39'),
(24, 1, 14, 'Bank', '03-005', 'dexdevs', '2019-10-21 07:10:51', 'dexdevs', '2019-10-21 07:10:51'),
(25, 1, 16, 'Miscellaneous Income', '03-006', 'dexdevs', '2019-10-21 08:10:42', 'dexdevs', '2019-10-21 08:10:42'),
(26, 1, 17, 'Stationery Expense', '06-003', 'dexdevs', '2019-10-21 08:10:39', 'dexdevs', '2019-10-21 08:10:39');
...
(16, 1, 'Income', '05-000', '2019-08-27 08:08:06'),
...
INSERT INTO `account_payable` (`id`, `transaction_id`, `amount`, `account_payable`, `due_date`, `created_at`, `updated_at`, `updated_by`, `status`, `organization_id`) VALUES
(4, 1, 500, 20, '2020-02-15', '2020-02-15', '2020-02-15', 0, 'Active', 1);
...
(19, 8, 1, -237500, 1, 1, 1, 1, '0000-00-00', '0000-00-00', '74', '2020-02-27 00:00:00'),
(20, 9, 3, 42.8, 1, 2, 1, 1, '0000-00-00', '0000-00-00', '74', '2020-02-14 00:00:00'),
...
(23, 12, 3, 47645558.4, 1, 3, 1, 1, '0000-00-00', '0000-00-00', '0', '0000-00-00 00:00:00'),
(24, 13, 3, 11910265.5, 1, 4, 1, 1, '0000-00-00', '0000-00-00', '0', '0000-00-00 00:00:00');
...
(16, 'Admin', 75, '2020-03-02 08:03:10'),
(17, 'Manager', 75, '2020-03-02 08:03:10'),
(18, 'Admin', 85, '2020-03-02 08:03:13'),
(19, 'Manager', 85, '2020-03-02 08:03:14'),
(20, 'Manager', 87, '2020-03-02 08:03:03');
...
CREATE TABLE `buy_plot` (
  ...
  `remaning_price` double NOT NULL,
  `plot_location` text NOT NULL,
  `city` varchar(50) NOT NULL,
  `district` varchar(50) NOT NULL,
  `province` varchar(50) NOT NULL,
  `buy_date` date NOT NULL,
  `status` enum('Partially Paid','Paid') NOT NULL,
  `created_at` date NOT NULL,
...
INSERT INTO `buy_plot` (`buy_plot_id`, `customer_id`, `property_name`, `plot_no`, `plot_area`, `plot_price`, `plot_paid_price`, `remaning_price`, `plot_location`, `city`, `district`, `province`, `buy_date`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `plot_status`, `organization_id`) VALUES
(2, 6, 'Muhallah', '2', '24', 300000, 154000, 146000, 'sdsd', 'RAHIM YAR KHAN', 'RAHIM YAR KHAN', 'Punjab', '2020-02-05', 'Partially Paid', '2020-02-12', 74, NULL, NULL, 'Owned', 1),
(3, 6, 'Gulshan ', '2', '24', 300000, 300000, 0, 'ijhkhjkh', 'RAHIM YAR KHAN', 'RAHIM YAR KHAN', 'Punjab', '2020-02-19', 'Paid', '2020-02-12', 74, NULL, NULL, 'Owned', 1);
...
(6, 4, 'Usama Javed', 'Javed Iqbal', '3130361465479', '3176310603', 'usama786.sa@gmail.com', 'Muhallah karigran tarinda saway khan', '', 74, 1, '2020-02-14'),
(7, 4, 'Arslan ', 'jkashdk', '3130361465478', '123089120938', 'klsklajsdl@gmai.cpom', 'am,sdklasj', '', 74, 1, '2020-02-11');
...
(5, '6 Months', 0, 52941176, NULL, 2, 3, 1, 1, 3),
(6, 'Monthly', 0, 15882354, NULL, 18, 3, 1, 1, 4);
...
(2, 1, 2, 237500, 0, '2019-12-03', '2020-12-03', '74', 1),
(3, 1, 3, 237500, 0, '2019-12-03', '2021-06-03', '74', 1),
(4, 1, 4, 237500, 0, '2019-12-03', '2021-12-03', '74', 1),
(5, 1, 5, 237500, 0, '2019-12-03', '2022-06-03', '74', 1),
(6, 2, 1, 1, 0, '2019-12-15', '2019-12-15', '74', 1),
(7, 2, 2, 4, 0, '2019-12-15', '2020-02-15', '74', 1),
...
(63, 5, 1, 5294117.6, 0, '2020-02-27', '2020-02-27', '74', 1),
(64, 5, 2, 23822780, 1, '2020-02-27', '2021-02-27', '74', 1),
(65, 5, 3, 23822780, 1, '2020-02-27', '2021-08-27', '74', 1),
(66, 6, 1, 3970588.5, 0, '2020-02-27', '2020-02-27', '74', 1),
(67, 6, 2, 661682, 1, '2020-02-27', '2020-04-27', '74', 1),
(68, 6, 3, 661682, 1, '2020-02-27', '2020-05-27', '74', 1),
(69, 6, 4, 661682, 1, '2020-02-27', '2020-06-27', '74', 1),
(70, 6, 5, 661682, 1, '2020-02-27', '2020-07-27', '74', 1),
(71, 6, 6, 661682, 1, '2020-02-27', '2020-08-27', '74', 1),
(72, 6, 7, 661682, 1, '2020-02-27', '2020-09-27', '74', 1),
(73, 6, 8, 661682, 1, '2020-02-27', '2020-10-27', '74', 1),
(74, 6, 9, 661682, 1, '2020-02-27', '2020-11-27', '74', 1),
(75, 6, 10, 661682, 1, '2020-02-27', '2020-12-27', '74', 1),
(76, 6, 11, 661682, 1, '2020-02-27', '2021-01-27', '74', 1),
(77, 6, 12, 661682, 1, '2020-02-27', '2021-02-27', '74', 1),
(78, 6, 13, 661682, 1, '2020-02-27', '2021-03-27', '74', 1),
(79, 6, 14, 661682, 1, '2020-02-27', '2021-04-27', '74', 1),
(80, 6, 15, 661682, 1, '2020-02-27', '2021-05-27', '74', 1),
(81, 6, 16, 661682, 1, '2020-02-27', '2021-06-27', '74', 1),
(82, 6, 17, 661682, 1, '2020-02-27', '2021-07-27', '74', 1),
(83, 6, 18, 661682, 1, '2020-02-27', '2021-08-27', '74', 1),
(84, 6, 19, 661682, 1, '2020-02-27', '2021-09-27', '74', 1);
...
INSERT INTO `organization` (`id`, `name`, `organization_address`, `contact`, `logo`, `user_id`, `created_at`) VALUES
(1, 'DEXDEVS', 'Gulshan-e-Nasir Rahim Yar Khan', '2147483647', 'uploads/reportsimages/uuu.jpg', 1, '2019-09-03'),
(2, 'abc', '', '0', '', 1, '2019-09-11'),
(4, 'test1', '', '0', '', 76, '2019-09-17');
...
(3, 1, 3, '12000', '1200', '52941.176', 'Commercial', 52941176, 1000, 'Sold', 'dexdevs', '2019-12-03', '', '0000-00-00', 1),
(4, 1, 4, '1200', '1200', '5294.118', 'Residential', 15882354, 3000, 'Sold', 'dexdevs', '2019-12-03', '', '0000-00-00', 1),
...
(5, 3, 1, 3, '2020-02-27', '0000-00-00', 1, 'Active'),
(6, 3, 1, 4, '2020-02-27', '0000-00-00', 1, 'Active');
...
(4, 'xyz', '65657', 'xyz', 5, 1),
(5, 'djn', '88998989898', 'akjskasjkasjk', 5, 1);
...
CREATE TABLE `transactions` (
  `id` int(11) NOT NULL,
  `buy_plot_id` int(11) DEFAULT NULL,
  `account_payable_id` int(11) DEFAULT NULL,
  `account_rec_id` int(11) DEFAULT NULL,
  `transaction_id` int(11) NOT NULL,
...
INSERT INTO `transactions` (`id`, `buy_plot_id`, `account_payable_id`, `account_rec_id`, `transaction_id`, `type`, `narration`, `debit_account`, `debit_amount`, `credit_account`, `credit_amount`, `transaction_date`, `date`, `ref_no`, `created_by`, `organization_id`) VALUES
(4, NULL, 4, NULL, 1, 'Cash Payment', 'hello', 20, 1200, 16, 1200, '2020-02-15', '2020-02-15', NULL, '74', 1),
(5, NULL, 4, NULL, 2, 'Cash Payment', 'hello', 20, 900, 16, 900, '2020-02-15', '2020-02-15', NULL, '74', 1),
(6, NULL, NULL, NULL, 3, 'Cash Payment', 'kljkl', 16, 237500, 21, 237500, '2020-02-27', '2020-02-27', NULL, '74', 1),
(7, NULL, NULL, NULL, 4, 'Cash Payment', 'lalsjkl', 16, 1200, 25, 1200, '2020-02-27', '2020-02-27', NULL, 'dexdevs', 1),
(8, NULL, NULL, NULL, 5, 'Cash Payment', 'ksjafklsd', 16, 5294117.6, 18, 5294117.6, '0000-00-00', '2020-02-27', NULL, '74', 1),
(9, NULL, NULL, NULL, 6, 'Cash Payment', 'ksjafklsd', 16, 5294117.6, 18, 5294117.6, '0000-00-00', '2020-02-27', NULL, '74', 1),
(10, NULL, NULL, NULL, 7, 'Cash Payment', 'ksjafklsd', 21, 47645558.4, 16, 47645558.4, '0000-00-00', '2020-02-27', NULL, '74', 1),
(11, NULL, NULL, NULL, 8, 'Cash Payment', 'sajkdh', 16, 3970588.5, 18, 3970588.5, '0000-00-00', '2020-02-27', NULL, '74', 1),
(12, NULL, NULL, NULL, 9, 'Cash Payment', 'sajkdh', 16, 3970588.5, 18, 3970588.5, '0000-00-00', '2020-02-27', NULL, '74', 1),
(13, NULL, NULL, NULL, 10, 'Cash Payment', 'sajkdh', 21, 11910265.5, 16, 11910265.5, '0000-00-00', '2020-02-27', NULL, '74', 1);
...
(74, '', '', 'Superadmin', 'uploads/logo.png', 'iFISDX0OMTSGTWyko_rObETNJMeJivkr', '$2y$13$Gi.0ikD78vx6otxPbos/DOHtgxb8rXG8eQHbpDFk52fe03vXVjHZi', NULL, 'Usama@gmail.com', 10, '1568449222', '1568449222', '-ZxYmGCPhElUxB9UlSkKT6meGLROvRer_1568449222', 0),
...
(85, 'dex', 'devs', 'dexdevs', 'uploads/dexdevs.jpg', 'QfSFWwOntIJeMbKEH-Nkbtb0C6oppJPy', '$2y$13$MHzAE9lCylxOBIam4pGzfudwgtXiza/RO8y1MH/lNCPo4AsJkxXyO', NULL, 'dexdevs@gmail.com', 10, '2020-03-02 08:03:13', '2020-03-02 08:03:13', 'JHyT4J4_YuArNNYBCpsaxnVPVaDCT2ex_1583134333', 1),
(87, 'abc', 'abc', 'abc1', 'uploads/abc1.jpg', 'lEU77fX6B3iXAlvb4xGeJObN-GYPkprU', '$2y$13$R7jy1uHm6LBhXwOrrr9qberjsB8ECZpqhwCjiJPt5LzQWd.WNI3ci', NULL, 'abc1@gmail.com', 10, '2020-03-02 08:03:03', '2020-03-02 08:03:03', 'QKdHje5sj1N-Wks6McBe4JOmzDjjeN6i_1583135463', 1);
...
--
ALTER TABLE `buy_plot`
  MODIFY `buy_plot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `provide_services`
  MODIFY `provide_services_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
