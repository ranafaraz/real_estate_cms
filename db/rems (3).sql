...
INSERT INTO `account_payable` (`id`, `transaction_id`, `recipient_id`, `amount`, `account_payable`, `property_name`, `plot_no`, `due_date`, `created_at`, `updated_at`, `updated_by`, `status`, `organization_id`) VALUES
(16, 1, 7, 390000, 18, 'Gulshan Iqbal', 1, '2019-10-31', '2019-10-15', NULL, NULL, 'Active', 1);
...
(9, 1, 6, 300000, 20, 1, 1, 1, '0000-00-00', '0000-00-00', '0', '0000-00-00 00:00:00');
...
(17, 7, 'Gulshan Iqbal', '1', '23*23', 1290000, 900000, 'djklnvkl', 'ryk', 'ryk', 'punjab', '0000-00-00', '2019-10-15', 74, NULL, NULL, 'Owned', 1);
...
(6, 3, 'Usama', 'Javed', '1234', '123456789876', 'Usama786.sa@gmail.com', 'qwdjhkqw', 74, 1, '2019-10-15'),
...
(21, 2, '2019-10-15', '2019-10', 20000, 20000, 'Partially Paid', 74, 0, '0000-00-00', '0000-00-00', 1),
(22, 2, '2019-10-15', '2019-10', 10000, 10000, 'Partially Paid', 74, 0, '0000-00-00', '0000-00-00', 1),
(23, 2, '2019-10-15', '2019-10', 10000, 0, 'Paid', 74, 0, '0000-00-00', '0000-00-00', 1);
...
(66, 12, 1, 200000, 0, '2019-10-15', '2019-10-15', '74', 1),
(67, 12, 2, 150000, 1, '2019-10-15', '2021-10-15', '74', 1),
(68, 12, 3, 150000, 1, '2019-10-15', '2022-10-15', '74', 1);
...
(175, 20, 1, '1123', '10', 'Residential', 500000, 123, 'Sold', 'Usama', '2019-09-11', '', '0000-00-00', 1),
...
(12, 6, 20, 1, '2019-10-15', '0000-00-00', 1, 'Active');
...
(34, 1, 'Cash Payment', '', 16, 200000, 18, 200000, '2019-10-15 00:00:00', NULL, '74', 1),
(35, 2, 'Cash Payment', '', 21, 300000, 16, 300000, '2019-10-15 00:00:00', NULL, '74', 1),
(36, 3, 'Cash Payment', '', 18, 1290000, 16, 900000, '2019-10-15 00:00:00', NULL, '74', 1);
...
--
ALTER TABLE `emp_salary`
  MODIFY `emp_salary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
ALTER TABLE `account_payable`
  ...
  ADD CONSTRAINT `account_payable_ibfk_2` FOREIGN KEY (`recipient_id`) REFERENCES `customer` (`customer_id`);
